<link rel="stylesheet" href="css/footer.css">
 ...
 <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
     ...
     <div id="container">
         <div id="part1">
             <div id="companyinfo"> <a id="sitelink" href="#">Logos Old Technologies</a>
                 <p id="title">Cool and Perfect Snippet code</p>
                 <p id="detail">We created first own project of periodicals</p>
             </div>
             <div id="explore">
                 <p id="txt1">Explore</p> <a class="link" href="/cabinet.jsp">Home</a> <a class="link" href="#">About</a> <a class="link" href="#">Snippet</a> <a class="link" href="#">Careers</a>
             </div>
             <div id="visit">
                 <p id="txt2">Visit</p>
                 <p class="text">My house </p>
                 <p class="text">Zlatopilska street, 4K</p>
                 <p class="text">Kyiv </p>
