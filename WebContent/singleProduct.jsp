...
<title>Product</title>
<link rel="stylesheet" href="css/serverCalls.css">
</head>
<body>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer d-flex justify-content-center">
					<button data-toggle="modal" data-target="#smallModal" product-id="${product.id}" class="btn btn-primary buy-product my-2">Buy</button>
				</div>
			</div>
		</div>
	</div>  
